...
arser.add_argument('--lr', type=float, default=0.0001)
arser.add_argument('--totalepi', type=int, default=500)
arser.add_argument('--maxsteps', type=int, default=100)
arser.add_argument('--bs', type=int, default=32)
arser.add_argument('--decayrate', type=float, default=0.0001)
arser.add_argument('--gamma', type=float, default=0.95)
arser.add_argument('--memsize', type=int, default=1000000)
...
learning_rate =  config.lr      # Alpha (aka learning rate)

### TRAINING HYPERPARAMETERS
total_episodes = config.totalepi        # Total episodes for training
max_steps = config.maxsteps             # Max possible steps in an episode
batch_size = config.bs             

# Exploration parameters for epsilon greedy strategy
explore_start = 1.0            # exploration probability at start
explore_stop = 0.01            # minimum exploration probability 
decay_rate = config.decayrate            # exponential decay rate for exploration prob
...
memory_size = config.memsize          # Number of experiences the Memory can keep
